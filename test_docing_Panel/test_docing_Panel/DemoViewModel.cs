...
{
    internal class DemoViewModel : DockPane
    {
        private const string _dockPaneID = "test_docing_Panel_Demo";
        private const string _menuID = "test_docing_Panel_Demo_Menu";
    ...
    /// </summary>
    internal class Demo_ShowButton : Button
    {
    ...
    /// </summary>
    internal class Demo_MenuButton : Button
    {
        protected override void OnClick()
        {
        }
